...
public class ClothingGuideMale {
        ...
        static {
                ...
                imageUrlMap.put("반팔 셔츠", "/images/guide/outer/male/shortsleeveshirts.png");
                imageUrlMap.put("반소매 가디건", "/images/guide/outer/male/shortsleevecardigan.png");
                imageUrlMap.put("얇은 셔츠", "/images/guide/outer/male/thinshirts.png");
                imageUrlMap.put("린넨 셔츠", "/images/guide/outer/male/linenshirts.png");
                imageUrlMap.put("긴소매", "/images/guide/top/male/longsleeve.png");
                imageUrlMap.put("셔츠", "/images/guide/outer/male/shirt.png");
                imageUrlMap.put("얇은 니트/스웨터", "/images/guide/top/male/thinknitsweater.png");
                imageUrlMap.put("얇은 가디건", "/images/guide/outer/male/thincardigan.png");
                imageUrlMap.put("바람막이", "/images/guide/outer/male/windbreaker.png");
                imageUrlMap.put("가디건", "/images/guide/outer/male/cardigan.png");
                ...
                imageUrlMap.put("블레이저", "/images/guide/outer/male/blazer.png");
                imageUrlMap.put("트렌치코트", "/images/guide/outer/male/trench.png");
                imageUrlMap.put("가죽자켓", "/images/guide/outer/male/bikerjacket.png");
                imageUrlMap.put("울코트", "/images/guide/outer/male/woolencoat.png");
                imageUrlMap.put("패딩코트", "/images/guide/outer/male/wintercoat.png");
                imageUrlMap.put("패딩", "/images/guide/outer/male/pufferjacket.png");
                ...
                imageUrlMap.put("화이트 데님", "/images/guide/bottom/male/whitedenim.png");
        ...
        static {
                guideMap.put(TemperatureRange.VERY_HOT, // 28 ~ 100
                                new GuideSet(
                                                Arrays.asList("반팔 셔츠", "린넨 셔츠", "얇은 셔츠", "반소매 가디건"),
                                                Arrays.asList("민소매", "반소매", "헨리넥 반소매", "피케/카라", "반팔 니트/스웨터"),
                                                Arrays.asList("면반바지", "데님 반바지", "린넨 팬츠", "화이트 데님", "얇은 데님", "얇은 슬랙스"),
                                                Arrays.asList("샌들/슬리퍼", "스니커즈", "구두")));
                guideMap.put(TemperatureRange.HOT, // 23 ~ 27
                                new GuideSet(
                                                Arrays.asList("반팔 셔츠", "린넨 셔츠", "얇은 셔츠", "반소매 가디건"),
                                                Arrays.asList("민소매", "반소매", "헨리넥 반소매", "피케/카라", "반팔 니트/스웨터"),
                                                Arrays.asList("화이트 데님", "얇은 데님", "얇은 슬랙스", "코튼 팬츠"),
                                                Arrays.asList("샌들/슬리퍼", "스니커즈", "스포츠화", "구두")));
                guideMap.put(TemperatureRange.WARM, // 20 ~ 22
                                new GuideSet(
                                                Arrays.asList("셔츠", "얇은 가디건"),
        ...
        public static Map<String, Map<String, String>> getRandomClothingWithImage(TemperatureRange range) {
                ...
                // 2) 아우터 뽑기 (남성용 조건)
                List<String> sleeveOuters = Arrays.asList(
                                "반팔 셔츠", "린넨 셔츠", "얇은 셔츠", "반소매 가디건");
                List<String> longSleeveOuters = Arrays.asList(
                                "가디건", "블레이저");
                List<String> knitOuters = Arrays.asList(
                                "울코트", "트렌치코트");
                List<String> sweatShirtOuters = Arrays.asList(
                                "패딩코트", "패딩");

                String outer = "";
                if (top.contains("반소매") || top.contains("민소매") || top.contains("헨리넥 반소매")) {
                        // 반소매·민소매 상의
                        outer = sleeveOuters.get(random.nextInt(sleeveOuters.size()));
                } else if (top.contains("롱슬리브")) {
                        // 긴소매 상의
                        outer = longSleeveOuters.get(random.nextInt(longSleeveOuters.size()));
                } else if ((top.contains("니트") || top.contains("스웨터")) && !top.contains("반팔")) {
                        // 긴소매 니트/스웨터
                        outer = knitOuters.get(random.nextInt(knitOuters.size()));
                } else if (top.contains("맨투맨")) {
                        // 맨투맨
                        outer = sweatShirtOuters.get(random.nextInt(sweatShirtOuters.size()));
                }
